...
func UpdateProject(project models.Project) error {
	...
	_, err = db.Exec(query, project.UserID, project.FeatureID, project.Name, project.Config, project.ID)
	if err != nil {
		return err
	}
	return nil
...
func AddProject(project models.Project) error {
	...
	_, err = db.Exec(query, project.UserID, project.FeatureID, project.Name, project.Config)
	if err != nil {
		return err
	}
	return nil
